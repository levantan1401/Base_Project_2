...
@section('title', 'Sửa Thông tin Users ')
@section('main')
<head>
    ...
    <div class="card-body">
         ...
         <form action="{{route('account.update', $data->id) }}" method="post">
            ...
            <div class="form-group" >
                ...
                <input type="text" name="name" id="name" value="{{ $data->name }}" class="form-control"aria-describedby="helpId">
            </div>
            <div class="form-row">
                <div class="form-group col-md-12">
                <label for="inputEmail4">Email</label>
                <input type="email" class="form-control" name="email" value="{{ $data->email }}" id="inputEmail4" placeholder="Email">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-6">
                <label for="">Số Điện Thoại</label>
                <input type="text" name="phone" id="phone" value="{{$data->phone}}" class="form-control"aria-describedby="helpId">
                </div>
                <div class="form-group col-md-6">
