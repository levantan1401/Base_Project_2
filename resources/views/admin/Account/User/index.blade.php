            ...
            <td>
                <div style="width: 200px;">
                        <a href="#" class="pull-left">
                            <img src="{{url('public/uploads/Avatar')}}/{{$user->avatar}}" alt="" style="width: 100px; margin-right: 10px">
                        </a>
                </div>
            </td>
            <td style="width: 330px">
                    <div class="media">
                        <div class="media-body">
                            <h4 class="media-heading">{{ $user->name }} <span class="badge badge-info" style="font-size: 10px;">{{ $user->chucvu}}</span></h4>
                        </div>
                    </div>
                </td>
            <td>{{ $user->email }}</td>
